    ...
    <div class="row">
        ...
        <div class="col-sm-9"><!-- /ate aki -->  
            ...
            <hr>
                    ...
                    <hr>
            <form class="form-horizontal" role="form" action="../servletCadastrarTamanho" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" class="form-control" name="quantidadesabores" placeholder="Quantidade de sabores"  required>
                    </div>
                </div>
