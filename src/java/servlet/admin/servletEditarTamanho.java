 ...
 */
@WebServlet(name = "servletEditarTamanho", urlPatterns = {"/servletEditarTamanho"})
public class servletEditarTamanho extends HttpServlet {
        ...
        try {
            ...
            if (verificausuarioestabelecimento.verificar(usuarioestabelecimento)) {
                try {
                    ...
                    response.sendRedirect("admin/editartamanho.jsp?erro=1&id=" + request.getParameter("id"));
