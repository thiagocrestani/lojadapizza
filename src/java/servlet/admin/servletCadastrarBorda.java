 ...
 */
@WebServlet(name = "servletCadastrarBorda", urlPatterns = {"/servletCadastrarBorda"})
public class servletCadastrarBorda extends HttpServlet {
        ...
        try {
            ...
            if (verificausuarioestabelecimento.verificar(usuarioestabelecimento)) {
                try {
                    ...
                    borda.setIdcategoriaproduto(Integer.parseInt(request.getParameter("idcategoria")));
