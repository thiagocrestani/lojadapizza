 ...
 */
@WebServlet(name = "servletEditarEstabelecimento", urlPatterns = {"/servletEditarEstabelecimento"})
public class servletEditarEstabelecimento extends HttpServlet {
        ...
        try {
            ...
            if (verificausuarioestabelecimento.verificar(usuarioestabelecimento)) {
                ...
                try {
                    ...
                    estabelecimento.setId(usuarioestabelecimento.getEstabelecimento());
                    estabelecimento.setDdd(Integer.parseInt(request.getParameter("ddd")));
                    ...
                    estabelecimento.setPontodereferencia(request.getParameter("pontodereferencia"));
                    dao.editar(estabelecimento);
                    response.sendRedirect("admin/dados.jsp?sucesso=1");
                } catch (Exception e) {
                    response.sendRedirect("admin/dados.jsp?erro=1");
                }
            } else {
