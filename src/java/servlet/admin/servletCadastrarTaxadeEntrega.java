 ...
 */
@WebServlet(name = "servletCadastrarTaxadeEntrega", urlPatterns = {"/servletCadastrarTaxadeEntrega"})
public class servletCadastrarTaxadeEntrega extends HttpServlet {
        ...
        try {
            ...
            if (verificausuarioestabelecimento.verificar(usuarioestabelecimento)) {
                ...
                try {
                    ...
                    dao.taxaentrega(usuarioestabelecimento.getEstabelecimento(), Float.parseFloat(request.getParameter("taxadeentrega")));
                    response.sendRedirect("admin/taxadeentrega.jsp?sucesso=1");
                } catch (Exception e) {
                    response.sendRedirect("admin/taxadeentrega.jsp?erro=1");
                }
            } else {
