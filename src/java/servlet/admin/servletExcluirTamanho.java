 ...
 */
@WebServlet(name = "servletExcluirTamanho", urlPatterns = {"/servletExcluirTamanho"})
public class servletExcluirTamanho extends HttpServlet {
        ...
        try {
            ...
            if (verificausuarioestabelecimento.verificar(usuarioestabelecimento)) {
                try {
                    ...
                    dao.excluir(Integer.parseInt(request.getParameter("id")), usuarioestabelecimento.getId());
