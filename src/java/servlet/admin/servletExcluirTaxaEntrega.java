 ...
 */
@WebServlet(name = "servletExcluirTaxaEntrega", urlPatterns = {"/servletExcluirTaxaEntrega"})
public class servletExcluirTaxaEntrega extends HttpServlet {
       ...
       try {
            ...
            if (verificausuarioestabelecimento.verificar(usuarioestabelecimento)) {
                try {
                    ...
                    dao.excluir(usuarioestabelecimento.getId(),Float.parseFloat(request.getParameter("distancia")));
